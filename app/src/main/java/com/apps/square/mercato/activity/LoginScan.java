...
public class LoginScan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
          /*      ActivityCompat.requestPermissions(LoginScan.this, new
                        String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, REQUEST_WRITE_PERMISSION);*/
                Intent i=new Intent(LoginScan.this,Register.class);
                startActivity(i);
            }
        });
        ...
        switch (requestCode) {
            case REQUEST_WRITE_PERMISSION:
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(LoginScan.this, "Permission Denied!", Toast.LENGTH_SHORT).show();
                }
        }
    }
